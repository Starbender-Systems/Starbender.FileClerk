...
public class BlazorServerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public BlazorServerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
