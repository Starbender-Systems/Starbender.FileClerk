...
using Starbender.FileClerk.Demo.Blazor.Client.Navigation;
...
using Starbender.FileClerk.Demo.Blazor.Client;
using Starbender.FileClerk.Demo.Blazor.Components;
using Volo.Abp;
...
[DependsOn(
    ...
    typeof(global::Starbender.FileClerk.Blazor.WebAssembly.Bundling.FileClerkBlazorWebAssemblyBundlingModule),
...
public class DemoBlazorModule : AbpModule
{
    ...
    private void ConfigureBundles(IHostEnvironment hostingEnvironment)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            globalStyles.AddContributors(typeof(DemoStyleBundleContributor));

            var globalScripts = options.ScriptBundles.Get(BlazorWebAssemblyStandardBundles.Scripts.Global);
            globalScripts.AddContributors(typeof(DemoScriptBundleContributor));
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<DemoDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Starbender.FileClerk.Demo.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<DemoDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Starbender.FileClerk.Demo.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<DemoApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Starbender.FileClerk.Demo.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<DemoApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Starbender.FileClerk.Demo.Application"));
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        Configure<AbpRouterOptions>(options =>
        {
            ...
            options.AdditionalAssemblies.Add(typeof(DemoBlazorClientModule).Assembly);
        });
    }
