...
namespace Starbender.FileClerk.Demo.Migrations
{
    ...
    [Migration("20260814180014_Added_FileClerkBlobProviders")]
    partial class Added_FileClerkBlobProviders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Starbender.FileClerk.BlobProviders.FileClerkBlobProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("ImplementationType")
                        .IsUnique();

                    b.HasIndex("Name")
                        .IsUnique();

                    b.ToTable("FileClerkBlobProviders", (string)null);
                });
